		...
		extends SwComponent
{
	...
	@SwIntendedCascade public SwWindow withPreferredSized(
			int width,
			int height
	)
	{
	...
	@SwIntendedCascade public SwWindow withSize(
			int width,
			int height
	)
	{
	...
	@SwIntendedCascade public SwWindow addWindowEventSubscriber(
