...
@Getter public class SwClamped<T extends Comparable<T>>
	implements
		...
		SwPipelineMember<T>
{
	public static <M extends Comparable<M>> SwClamped<M> acquire(M lower, M upper)
	{
		return new SwClamped<>(lower, upper);
	}

	public static SwClamped<Integer> acquireUInt()
	{
		return new SwClamped<>(0, Integer.MAX_VALUE);
	}

	public static SwClamped<Float> acquireUFloat()
	{
		return new SwClamped<>(0.0F, Float.MAX_VALUE);
	}

	public static SwClamped<Byte> acquireUByte()
	{
		return new SwClamped<>((byte) 0x0, Byte.MAX_VALUE);
	}

	public static SwClamped<Short> acquireUShort()
	{
		return new SwClamped<>((short) 0, Short.MAX_VALUE);
	}

	public static SwClamped<Long> acquireULong()
	{
		return new SwClamped<>(0L, Long.MAX_VALUE);
	}
